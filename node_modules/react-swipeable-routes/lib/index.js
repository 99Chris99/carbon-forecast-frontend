...
var SwipeableRoutes = function (_Component) {
  ...
  function SwipeableRoutes() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      var _React$Children$toArr = _react2.default.Children.toArray(_this.props.children)[index].props,
      ...
      if (path.includes(":")) {
        if (path in _this.state.urls) {
          ...
          url = (0, _generatePath2.default)(path, defaultParams);
      ...
      _react2.default.Children.forEach(children, function (element, index) {
        ...
        if ((0, _reactRouter.matchPath)(location.pathname, { path: path, exact: exact, strict: strict })) {
          if (typeof _this.props.onChangeIndex === "function") {
  ...
  SwipeableRoutes.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (prevProps.index !== this.props.index) {
      var paths = _react2.default.Children.map(this.props.children, function (element) {
  ...
  SwipeableRoutes.prototype.render = function render() {
    ...
    if (index) {
      ...
      _react2.default.Children.forEach(children, function (element, index) {
        ...
        match = (0, _reactRouter.matchPath)(location.pathname, { path: path, exact: exact, strict: strict });
        if (match) {
          matchedIndex = index;
        }
      });
    ...
    var renderableRoutes = _react2.default.Children.toArray(children).filter(function (element, index) {
    ...
    return _react2.default.createElement(
      ...
      renderableRoutes.map(function (element, index) {
        ...
        var match = (0, _reactRouter.matchPath)(location.pathname, element.props);
        if (match) {
          match.type = "full";
        } else if (path in _this3.state.urls) {
          match = (0, _reactRouter.matchPath)(_this3.state.urls[path], element.props);
          match.type = "outOfView";
        } else {
          match = (0, _reactRouter.matchPath)((0, _generatePath2.default)(path, element.props.defaultParams), element.props);
          match.type = "none";
        }
        props.match = match;
        props.key = path;
        ...
        return component ? _react2.default.createElement(component, props) : render ? render(props) : children ? typeof children === "function" ? children(props) : !Array.isArray(children) || children.length // Preact defaults to empty children array
...
exports.default = (0, _reactRouter.withRouter)(SwipeableRoutes);
